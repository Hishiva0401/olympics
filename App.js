  ...
  return (
    <div>
      ...
      <h6>
        ...
        <a href="https://github.com/Hishiva0401/olympics">GitHub</a>, including{" "}
        <a href="https://github.com/Hishiva0401/olympics/blob/main/Scraper.py">
          Scraper
        </a>
        ,{" "}
        <a href="https://github.com/Hishiva0401/olympics/blob/main/Probability.py">
          Code for estimating statistics
        </a>{" "}
        and{" "}
        <a href="https://github.com/Hishiva0401/olympics/blob/main/Plotter.py">
